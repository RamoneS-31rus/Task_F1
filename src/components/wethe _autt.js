  ...
  render() {
    ...
    return (
      <div className="current">
        {this.props.city && (
          <div>
            <div className="current__city">{this.props.city}</div>
            <img
              className="current__img"
              src={`https://openweathermap.org/img/wn/${icon}@4x.png`}
              alt={this.props?.api?.current?.weather.map(
            ...
            <div className="current__descriptions">
              ...
              <div className="current__descriptions--item">
                {this.props?.api?.current?.weather.map(
                  (item) => item.description
                )}
              </div>
            </div>
            ...
            <div className="current__pressure">
              ...
              <div className="current__pressure--item">
                {this.props.pressure}
              </div>
            </div>
          </div>
