...
import WetheAutt from "./wethe _autt";
import HurlyWeather from "./HurlyWeather";
  ...
  render() {
    return (
      <div className="conteiner">
        <Form wetherMetod={this.gettingWether} />
        ...
        <WetheAutt
          ...
          api={this.state.api}
        />
        <HurlyWeather api={this.state.api} exclude={this.state.ex} />
      </div>
    );
  }
}
